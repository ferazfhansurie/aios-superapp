...
test("core pane policy keeps only browser, chat, terminal, files, history, mission, and ticket surfaces", () => {
  assert.deepEqual([...CORE_PANE_TYPES], ["browser", "chat", "files", "history", "oracle", "shell", "tmux", "mission", "ticket"]);
  for (const type of ["browser", "chat", "files", "oracle", "shell", "tmux", "mission", "ticket"]) {
